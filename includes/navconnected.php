...
<li><a class="blue-text" href="editprofile.php">Modifier</a></li>
<li><a class="blue-text" href="includes/logout.php">déconnecter</a></li>
</ul>
<div class="navbar-fixed">
 <nav class="navblack">
   ...
   <ul class="left hide-on-med-and-down">
     ...
     <li><a href="index.php" class="dark-text">Covoiturage</a></li>
   ...
   <ul  class="right hide-on-med-and-down">
       <li><a href="index.php" class="dark-text">Accueil</a></li>
